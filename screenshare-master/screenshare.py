...
if __name__ == '__main__':
    ...
    parser.add_argument("-p", "--port", help="port, default 18331", type=int, default=5000)
    parser.add_argument("-w", "--password", help="password, default no password", default="1234%^&*abc")
